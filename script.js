...
const poll = {
    ...
    registerNewAnswer () { 
        /*TAREA 1. Cree un método llamado 'registerNewAnswer' en el objeto 'poll'. El método hace 2 cosas:
        ...
        if(input>=0&&input<=this.answers.length-1){
            this.answers[input]++;
            /*TAREA 4. Ejecute el método 'displayResults' al final de cada llamada al método
            'registerNewAnswer'.*/
            this.displayResults(this.answers);
        }
        else
            alert("El valor no esta en la encuesta");
    },
    /*TAREA 3. Cree un método 'displayResults' que muestre los resultados de la encuesta. El
...
/*TAREA 5. Use el método 'displayResults' para mostrar las 2 matrices que se muestran al
